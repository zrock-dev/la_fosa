...
onready var water_spring = preload("res://src/water_escene/preload/Water_Spring.tscn")
...
onready var splash_particle = preload("res://src/water_escene/preload/splash_particles.tscn")
